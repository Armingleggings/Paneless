...
{
    // This file is built to house the various values and functions that would be useful for any/all devleopment in C#
    // It's to overcome C# weaknesses or at least make it work more like what I would expect. For example, functions taht other languages have that are very useful but absent in C# for some reason.
